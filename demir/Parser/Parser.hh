...
private:
    ...
    auto parse_expression_with_precedence(this Parser &, AST::Precedence precedence, AST::NodeID lhs_expr_id) -> AST::NodeID;
    ...
    auto parse_call_function_expression(this Parser &, AST::NodeID lhs_expr_id) -> AST::NodeID;
};
} // namespace demir
